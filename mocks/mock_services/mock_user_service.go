...
//
//	mockgen -source=internal/services/user_service.go -destination=mocks/mock_services/mock_user_service.go -package=mockservices
//
...
func (m *MockIUserService) Store(ctx context.Context, params repositories.CreateOneParams) (*models.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Store", ctx, params)
	ret0, _ := ret[0].(*models.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIUserServiceMockRecorder) Store(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Store", reflect.TypeOf((*MockIUserService)(nil).Store), ctx, params)
}
